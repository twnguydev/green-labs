...
@section('content')
    <div class="bg-gray-100 mt-5 pt-10 min-h-screen pb-16">
        <div class="container mx-auto py-16">
            <a class="text-3xl pl-4 font-bold leading-none text-green-700" href="{{ route('dashboard') }}">
                Profil de {{ $user->first_name }} <i class="fa-solid fa-leaf"></i>
            </a>
            <div class="grid grid-cols-1 mt-5 sm:grid-cols-2 gap-6 px-4">
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    <span class="text-gray-700 uppercase font-bold tracking-wider mb-2">À propos du vendeur</span>
                    ...
                    <hr class="my-6 border-t border-gray-300">
                    <div class="flex flex-col">
                        <span class="text-gray-700 uppercase font-bold tracking-wider">Derniers articles en vente</span>
                        @if ($products->isEmpty())
                            <p class="text-lg mt-5 text-gray-700">Ce vendeur n'a pas encore mis en ligne d'articles.</p>
                        @endif
